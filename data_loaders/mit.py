...
def populate_train_list(images_path, mode='train'):
    ...
    image_list_lowlight = glob(os.path.join(images_path, '*.png'))
...
class lowlight_loader_new(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            data_lowlight = data_lowlight.resize((512, 512))
            data_highlight = data_highlight.resize((512, 512))
...
if __name__ == "__main__":
    ...
    images_path = '/root/autodl-tmp/LOLv1/eval15/low/'

    train_list = populate_train_list(images_path)
    # print(train_list)
    train_dataset = lowlight_loader_new(images_path, mode='train')
