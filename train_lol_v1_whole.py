...
parser.add_argument('--img_path', type=str, default='/root/autodl-tmp/LOLv1/our485/low/')
...
for epoch in range(config.num_epochs):
    ...
    torch.save(model.state_dict(), os.path.join(config.snapshots_folder, f"Epoch_{epoch}" + '.pth'))
